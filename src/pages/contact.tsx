...
export function ContactPage() {
  return (
    <div className="container mx-auto px-4 py-12 bg-black min-h-screen flex flex-col items-center">
      <div className="max-w-4xl w-full">
        
        {/* Profile Card */}
        <div className="bg-gray-900 text-white p-6 rounded-lg shadow-lg mb-8 border border-gray-700 text-center sm:text-left">
        ...
        <h1 className="text-4xl font-bold text-[#20B2AA] mb-8 text-center sm:text-left">
          Contact Me
        </h1>

        <p className="text-xl text-gray-400 mb-12 text-center sm:text-left">
          You can reach me via the following platforms or drop me an email!
        </p>

        <div className="space-y-6">
          {/* Email Card */}
          <div className="bg-gray-900 p-6 rounded-lg shadow-lg border border-gray-700 transition transform hover:scale-105 hover:shadow-xl">
          ...
          <div className="bg-gray-900 p-6 rounded-lg shadow-lg border border-gray-700 transition transform hover:scale-105 hover:shadow-xl">
            ...
            <Button
              ...
              onClick={() => window.open("https://www.linkedin.com/in/teja-karanam-60a14a267/", "_blank", "noopener noreferrer")}
            >
              Connect on LinkedIn
            </Button>
          </div>
          ...
          <div className="bg-gray-900 p-6 rounded-lg shadow-lg border border-gray-700 transition transform hover:scale-105 hover:shadow-xl">
            ...
            <Button
              ...
              onClick={() => window.open("https://www.instagram.com/teja_karanam.792/", "_blank", "noopener noreferrer")}
            >
              Follow on Instagram
            </Button>
          </div>
          ...
          <div className="bg-gray-900 p-6 rounded-lg shadow-lg border border-gray-700 transition transform hover:scale-105 hover:shadow-xl">
            ...
            <Button
              ...
              onClick={() => window.open("https://t.me/TejaKaranam", "_blank", "noopener noreferrer")}
            >
              Message on Telegram
            </Button>
          </div>
